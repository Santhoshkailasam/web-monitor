            ...
            >
              {!report && !loading && (
                <>
                  ...
                  <div className="container" style={{ display: 'flex', justifyContent: 'center', gap: '1rem', marginTop: '-2rem' }}>
...
const LoginView = ({ onLogin }) => (
  <motion.div 
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
    style={{ height: '70vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '2rem' }}
  >
    <div style={{ textAlign: 'center' }}>
      <h1 className="gradient-text" style={{ fontSize: '3rem', marginBottom: '1rem' }}>Welcome to SpeedGenius</h1>
      <p style={{ color: 'var(--text-secondary)', fontSize: '1.25rem' }}>Login to start optimizing your performance.</p>
    </div>
    <button className="btn-primary" onClick={onLogin} style={{ padding: '1rem 3rem', fontSize: '1.1rem' }}>
      <FiLogIn size={20} /> Sign in with Google
    </button>
  </motion.div>
);
